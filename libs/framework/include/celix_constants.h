...
#define CELIX_FRAMEWORK_BUNDLE_ACTIVATOR_GET_BUNDLE_CONTEXT "celix_bundleActivator_getBundleContext"
#define CELIX_FRAMEWORK_BUNDLE_ACTIVATOR_GET_CXX_BUNDLE_CONTEXT "celix_bundleActivator_getCxxBundleContext"
