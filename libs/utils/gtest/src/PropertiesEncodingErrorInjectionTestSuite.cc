...
TEST_F(PropertiesEncodingErrorInjectionTestSuite, SaveErrorTest) {
    ...
    celix_ei_expect_json_object((void*)celix_properties_saveToStream, 1, nullptr);
...
TEST_F(PropertiesEncodingErrorInjectionTestSuite, EncodeErrorTest) {
    ...
    // When an error injected is prepared for json_object_set_new() from celix_properties_saveToString
    celix_ei_expect_json_object_set_new((void*)celix_properties_saveToString, 4, -1);
...
TEST_F(PropertiesEncodingErrorInjectionTestSuite, EncodeArrayErrorTest) {
    ...
    celix_ei_expect_json_array((void*)celix_properties_saveToString, 6, nullptr);
...
TEST_F(PropertiesEncodingErrorInjectionTestSuite, EncodeVersionErrorTest) {
    ...
    celix_ei_expect_json_sprintf((void*)celix_properties_saveToString, 5, nullptr);
    ...
    celix_ei_expect_celix_version_toString((void*)celix_properties_saveToString, 5, nullptr);
...
TEST_F(PropertiesEncodingErrorInjectionTestSuite, DecodeErrorTest) {
    constexpr const char* json = R"({"key":"value","object":{"key":"value"}})";
    celix_ei_expect_malloc((void*)celix_properties_loadFromString, 3, nullptr);
    celix_properties_t* props = nullptr;
    EXPECT_EQ(ENOMEM, celix_properties_loadFromString(json, 0, &props));
    EXPECT_EQ(1, celix_err_getErrorCount());
}
...
TEST_F(PropertiesEncodingErrorInjectionTestSuite, DecodeVersionErrorTest) {
    constexpr const char* json = R"({"key":"version<1.2.3.qualifier>"})";
    celix_autoptr(celix_properties_t) props = nullptr;
    ASSERT_EQ(CELIX_SUCCESS, celix_properties_loadFromString(json, 0, &props));
